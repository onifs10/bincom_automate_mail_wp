...
<input value=<?= $value ?> style="margin: 5px 0px" type="text" class="large-text" name="updateMail[<?= $name ?>]" id="" <?php if($required) {echo" required"; } ?>>
    ...
    <div class='metabox-holder'
        ...
        <form method="post" class='form' style="flex: 0 0 80%; ">
            ...
            <button type="submit" class="button button-primary" name='edit_mail'
                value="<?= wp_create_nonce('edit_mail')?>"> Edit Mail </button>
        </form>
    </div>
</div>